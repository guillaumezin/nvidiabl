...
NVIDIABL_DECLARE_LAPTOP_MODEL("Dell Inc.", "Vostro 3400", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
...
NVIDIABL_DECLARE_LAPTOP_MODEL("SAMSUNG ELECTRONICS CO., LTD.", "RV409/RV509/RV709", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),

NVIDIABL_DECLARE_LAPTOP_MODEL("TOSHIBA", "SATELLITE PRO U500", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
NVIDIABL_DECLARE_LAPTOP_MODEL("TOSHIBA", "SATELLITE L750", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
...
NVIDIABL_DECLARE_LAPTOP_MODEL("LENOVO", "42844MG", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
...
NVIDIABL_DECLARE_LAPTOP_MODEL("ASUSTeK COMPUTER INC.", "G75VW", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
NVIDIABL_DECLARE_LAPTOP_MODEL("ASUSTeK Computer Inc.", "G74Sx", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
NVIDIABL_DECLARE_LAPTOP_MODEL("ASUSTeK Computer Inc.", "G55VW", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),

NVIDIABL_DECLARE_LAPTOP_MODEL("Compal", "PBL01", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),

NVIDIABL_DECLARE_LAPTOP_MODEL("Quanta", "TW9", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),

NVIDIABL_DECLARE_LAPTOP_MODEL("FUJITSU", "AMILO Pi 3560", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),

NVIDIABL_DECLARE_LAPTOP_MODEL("Acer", "TravelMate 8481TG", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, 0x08000),

NVIDIABL_DECLARE_LAPTOP_MODEL("Hewlett-Packard", "HP Pavilion dv3500 Notebook PC", PCI_ANY_ID, NVIDIABL_AUTO, NVIDIABL_AUTO, NVIDIABL_AUTO),
